...
// Ed25519Signer adapts an AWS KMS ed25519 key to the gRPC SignerService
// signing.Signer interface. signing is performed by the KMS Sign API and the
// private key never leaves KMS. KMS ed25519 is PureEd25519 over MessageType RAW.
// secp256k1 keys use Secp256k1Signer (see secp256k1.go).
...
func OpenSigner(ctx context.Context, cfg Config) (signing.Signer, error) {
	...
	return &Ed25519Signer{be: be}, nil
}

// PubKey returns the 32-byte ed25519 public key, the canonical SignerService
// encoding for ED25519.
func (s *Ed25519Signer) PubKey() []byte { return s.be.pub.Bytes() }

// Scheme reports ED25519.
func (s *Ed25519Signer) Scheme() pb.SignatureScheme { return pb.SignatureScheme_ED25519 }
